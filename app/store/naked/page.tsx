        ...
        <main className="min-h-screen bg-zinc-950 text-white pb-20 selection:bg-red-600 selection:text-white">
            ...
            <nav className="flex justify-between items-center p-6 border-b border-white/10 bg-zinc-950/80 sticky top-0 backdrop-blur-xl z-40">
                ...
                <div className="flex gap-8 items-center font-bold tracking-wider text-sm">
                    <Link href="/store/naked" className="text-red-500 border-b-2 border-red-500 pb-1">NAKED</Link>
                    <Link href="/store/race" className="text-zinc-500 hover:text-red-500 transition-colors pb-1">RACE</Link>
            ...
            >
                ...
                <div className="relative z-10 text-center">
                    <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-4">
                        Raw <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-800">Power</span>
                    </h1>
                    <p className="text-zinc-400 text-lg md:text-xl tracking-widest uppercase">Stripped down to the essentials.</p>
                </div>
            </motion.div>
